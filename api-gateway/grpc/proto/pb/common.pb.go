...
type PageRequest struct {
	...
	CompanyId string `protobuf:"bytes,6,opt,name=companyId,proto3" json:"companyId"`
}
...
func (x *PageRequest) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *PageRequest) GetTo() string {
	if x != nil {
		return x.To
	}
	return ""
...
func (x *PageRequest) GetCompanyId() string {
	if x != nil {
		return x.CompanyId
	}
	return ""
...
var file_common_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x8f, 0x01, 0x0a, 0x0b,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x66,
	...
	0x28, 0x09, 0x52, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x49, 0x64, 0x42, 0x0f, 0x5a,
