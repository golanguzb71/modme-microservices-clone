...
type GetHistoryGroupResponse struct {
	...
	History        []*AbsHistory        `protobuf:"bytes,1,rep,name=history,proto3" json:"history"`
	StudentHistory []*AbsStudentHistory `protobuf:"bytes,2,rep,name=studentHistory,proto3" json:"studentHistory"`
}
