...
type CreateRoomRequest struct {
	...
	Capacity int32  `protobuf:"capacity" json:"capacity"`
}
...
type GetUpdateRoomAbs struct {
	...
	Rooms []*AbsRoom `protobuf:"rooms" json:"rooms"`
}
...
type CreateCourseRequest struct {
	...
	Name           string  `protobuf:"name" json:"name"`
	LessonDuration int32   `protobuf:"lessonDuration" json:"lessonDuration"`
	CourseDuration int32   `protobuf:"courseDuration" json:"courseDuration"`
	Price          float64 `protobuf:"price" json:"price"`
	Description    string  `protobuf:"description" json:"description"`
}
...
type GetUpdateCourseAbs struct {
	...
	Courses []*AbsCourse `protobuf:"courses" json:"courses"`
}
...
type GetCourseByIdResponse struct {
	...
	Price          float64 `protobuf:"price" json:"price"`
	Description    string  `protobuf:"description" json:"description"`
	StudentCount   int32   `protobuf:"studentCount" json:"studentCount"`
}
...
type CreateGroupRequest struct {
	...
	Name            string   `protobuf:"name" json:"name"`
	CourseId        int32    `protobuf:"courseId" json:"courseId"`
	TeacherId       string   `protobuf:"teacherId" json:"teacherId"`
	Type            string   `protobuf:"type" json:"type"`
	Days            []string `protobuf:"days" json:"days"`
	RoomId          int32    `protobuf:"roomId" json:"roomId"`
	LessonStartTime string   `protobuf:"lessonStartTime" json:"lessonStartTime"`
	GroupStartDate  string   `protobuf:"groupStartDate" json:"groupStartDate"`
	GroupEndDate    string   `protobuf:"groupEndDate" json:"groupEndDate"`
}
...
type GetGroupAbsResponse struct {
	...
	Id           string     `protobuf:"id" json:"id"`
	Course       *AbsCourse `protobuf:"course" json:"course"`
	TeacherName  string     `protobuf:"teacherName" json:"teacherName"`
	TimeDays     string     `protobuf:"timeDays" json:"timeDays"`
	Room         *AbsRoom   `protobuf:"room" json:"room"`
	StudentCount int32      `protobuf:"studentCount" json:"studentCount"`
	Name         string     `protobuf:"name" json:"name"`
	IsArchived   bool       `protobuf:"isArchived" json:"isArchived"`
	CreatedAt    string     `protobuf:"createdAt" json:"createdAt"`
	StartDate    string     `protobuf:"startDate" json:"startDate"`
	EndDate      string     `protobuf:"endDate" json:"endDate"`
}
...
type GetGroupsResponse struct {
	...
	Groups []*GetGroupAbsResponse `protobuf:"groups" json:"groups"`
}
...
var file_education_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x4b, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x52, 0x65,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x32, 0x83,
	...
	0x6f, 0x6e, 0x2e, 0x41, 0x62, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xe4,
	...
	0x73, 0x65, 0x12, 0x41, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x12,
	0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x1c, 0x2e, 0x65, 0x64, 0x75, 0x63, 0x61, 0x74,
...
var file_education_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
var file_education_proto_depIdxs = []int32{
	...
	0,  // 5: education.RoomService.CreateRoom:input_type -> education.CreateRoomRequest
	13, // 6: education.RoomService.GetRooms:input_type -> google.protobuf.Empty
	2,  // 7: education.RoomService.UpdateRoom:input_type -> education.AbsRoom
	14, // 8: education.RoomService.DeleteRoom:input_type -> common.DeleteAbsRequest
	3,  // 9: education.CourseService.CreateCourse:input_type -> education.CreateCourseRequest
	13, // 10: education.CourseService.GetCourses:input_type -> google.protobuf.Empty
	7,  // 11: education.CourseService.GetCourseById:input_type -> education.GetCourseByIdRequest
	5,  // 12: education.CourseService.UpdateCourse:input_type -> education.AbsCourse
	14, // 13: education.CourseService.DeleteCourse:input_type -> common.DeleteAbsRequest
	8,  // 14: education.GroupService.CreateGroup:input_type -> education.CreateGroupRequest
	13, // 15: education.GroupService.GetGroups:input_type -> google.protobuf.Empty
	9,  // 16: education.GroupService.GetGroupById:input_type -> education.GetGroupByIdRequest
	10, // 17: education.GroupService.UpdateGroup:input_type -> education.GetUpdateGroupAbs
	14, // 18: education.GroupService.DeleteGroup:input_type -> common.DeleteAbsRequest
	15, // 19: education.RoomService.CreateRoom:output_type -> common.AbsResponse
	1,  // 20: education.RoomService.GetRooms:output_type -> education.GetUpdateRoomAbs
	15, // 21: education.RoomService.UpdateRoom:output_type -> common.AbsResponse
	15, // 22: education.RoomService.DeleteRoom:output_type -> common.AbsResponse
	15, // 23: education.CourseService.CreateCourse:output_type -> common.AbsResponse
	4,  // 24: education.CourseService.GetCourses:output_type -> education.GetUpdateCourseAbs
	6,  // 25: education.CourseService.GetCourseById:output_type -> education.GetCourseByIdResponse
	15, // 26: education.CourseService.UpdateCourse:output_type -> common.AbsResponse
	15, // 27: education.CourseService.DeleteCourse:output_type -> common.AbsResponse
	15, // 28: education.GroupService.CreateGroup:output_type -> common.AbsResponse
	12, // 29: education.GroupService.GetGroups:output_type -> education.GetGroupsResponse
	11, // 30: education.GroupService.GetGroupById:output_type -> education.GetGroupAbsResponse
	15, // 31: education.GroupService.UpdateGroup:output_type -> common.AbsResponse
	15, // 32: education.GroupService.DeleteGroup:output_type -> common.AbsResponse
